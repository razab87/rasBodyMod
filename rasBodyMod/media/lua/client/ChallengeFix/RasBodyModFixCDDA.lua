...
function CDDA.AddPlayer(playerNum, playerObj, ...)
        ...
        manageBody.EquipBodyHair(playerObj, "RasPubicHair") -- equip body hair items
        manageBody.EquipBodyHair(playerObj, "RasLegHair")
        manageBody.EquipBodyHair(playerObj, "RasArmpitHair")
