...
function manageBody.EquipBodyHair(player, bodyLocation)
     ...
     local backUpItems = {} 
     reduceInvWeight(player, playerInv, backUpItems) -- temporarily reduce inventory weight when it exceeds limit (restored below)
...
Events.OnClothingUpdated.Add(manageBody.EquipBeardStubble) -- is always called when smth about beard changes (important: apperently also when beard grows which happens in java IsoGameCharacter.class)
