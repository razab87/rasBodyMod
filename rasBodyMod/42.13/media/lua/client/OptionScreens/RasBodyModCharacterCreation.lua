...
local function isClothingLocation(location)
       ...
       if rasSharedData.BodyHairLocations[location] or location:toString() == "rasbomo:maleprivatepart" or location:toString() == "rasbomo:skin" or 
          location:toString() == "rasbomo:beardstubble" or location:toString() == "rasbomo:headstubble" then
            return false
       end
...
local function assignRandomBodyHair(desc)
         if desc:isFemale() then -- for female               
               ...
               if n <= 25 then
                   rasClientData.SelectedBodyHair["Female"][Regs.ArmpitHair] = "RasBodyMod.FemaleArmpit"
               else
                   rasClientData.SelectedBodyHair["Female"][Regs.ArmpitHair] = "None"
               end
               -- legs
               n = ZombRand(101)
               if n <= 5 then
                   rasClientData.SelectedBodyHair["Female"][Regs.LegHair] = "RasBodyMod.FemaleLeg"
               else
                   rasClientData.SelectedBodyHair["Female"][Regs.LegHair] = "None"
               end
               -- assign pubic hair
               n = ZombRand(101)
               if n <= 55 then        
                    rasClientData.SelectedBodyHair["Female"][Regs.PubicHair] = "RasBodyMod.FemalePubicNatural"
               elseif n <= 85 then
                    rasClientData.SelectedBodyHair["Female"][Regs.PubicHair] = "RasBodyMod.FemalePubicTrimmed"
               elseif n <= 95 then
                   rasClientData.SelectedBodyHair["Female"][Regs.PubicHair] = "RasBodyMod.FemalePubicStrip"
               else
                    rasClientData.SelectedBodyHair["Female"][Regs.PubicHair] = "None" -- in this case, remove all body hair for more visual consistency
                    rasClientData.SelectedBodyHair["Female"][Regs.LegHair] = "None"
                    rasClientData.SelectedBodyHair["Female"][Regs.ArmpitHair] = "None"
               end 
         else -- for male
               ...
               local n = ZombRand(101)
               if n <= 5 then
                   rasClientData.SelectedBodyHair["Male"][Regs.ArmpitHair] = "None"
               else
                   rasClientData.SelectedBodyHair["Male"][Regs.ArmpitHair] = "RasBodyMod.MaleArmpit"
               end
               -- legs
               n = ZombRand(101)
               if n <= 5 then
                   rasClientData.SelectedBodyHair["Male"][Regs.LegHair] = "None"
               else
                   rasClientData.SelectedBodyHair["Male"][Regs.LegHair] = "RasBodyMod.MaleLeg"
               end
               -- chest
               n = ZombRand(101)
               if n <= 90 then
                   rasClientData.SelectedBodyHair["Male"][Regs.ChestHair] = "RasBodyMod.MaleChest"
               else
                   rasClientData.SelectedBodyHair["Male"][Regs.ChestHair] = "None"
               end   
               -- assign pubic hair
               n = ZombRand(101)
               if n <= 85 then        
                  rasClientData.SelectedBodyHair["Male"][Regs.PubicHair] = "RasBodyMod.MalePubicNatural"
               elseif n <= 95 then
                  rasClientData.SelectedBodyHair["Male"][Regs.PubicHair] = "RasBodyMod.MalePubicStrip"
               else
                  rasClientData.SelectedBodyHair["Male"][Regs.PubicHair] = "None"
                  rasClientData.SelectedBodyHair["Male"][Regs.ChestHair] = "None" -- also remove chest hair (for more visual consistency)
               end 
...
function CharacterCreationMain:loadOutfit(box,...)
       ...
       if desc:isFemale() then
           rasClientData.SelectedBodyHair["Female"][Regs.ArmpitHair] = "None"
           rasClientData.SelectedBodyHair["Female"][Regs.PubicHair] = "None"
           rasClientData.SelectedBodyHair["Female"][Regs.LegHair] = "None"
           rasClientData.HeadStubble = 0
       else
           rasClientData.SelectedBodyHair["Male"][RegsChestHair] = "None"
           rasClientData.SelectedBodyHair["Male"][Regs.ArmpitHair] = "None"
           rasClientData.SelectedBodyHair["Male"][Regs.PubicHair] =  "None"
           rasClientData.SelectedBodyHair["Male"][Regs.LegHair] = "None"
           rasClientData.BeardStubble = 0
