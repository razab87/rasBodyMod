...
local function adjustScreen(self)
        ...
        BH_LBL_LEN = math.max(
            getTextManager():MeasureStringX(UIFont.Small, getText("UI_ClothingType_rasbomo:pubichair")),
            getTextManager():MeasureStringX(UIFont.Small, getText("UI_ClothingType_rasbomo:armpithair")),
            getTextManager():MeasureStringX(UIFont.Small, getText("UI_ClothingType_rasbomo:leghair")),
            getTextManager():MeasureStringX(UIFont.Small, getText("UI_ClothingType_rasbomo:chesthair"))
        )       
...
local function doBodyHairCombo(self, definition)
	...
	for bodyLocation, profTable in pairs(definition) do          
	    if rasSharedData.BodyHairLocations[bodyLocation] then  
		        ...
		        if not combo then
			        createBodyHairCombo(self, getText("UI_ClothingType_" .. bodyLocation:toString()), bodyLocation);
			        combo = self.bodyHairCombo[bodyLocation];
